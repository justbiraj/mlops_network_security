from networksecurity.entity.artifact_entily import DataIngestionArtifact, DataValidationArtifact
...
class DataValidaion:
    ...
    def detect_dataset_drift(self, base_df, current_df, threshold=0.05)-> bool:
        try:
            ...
            dir_path = os.path.join(self.data_validation_config.drift_report_dir)
            os.makedirs(dir_path, exist_ok=True)
            dir_path = os.path.join(self.data_validation_config.drift_report_file_path)
            write_yaml_file(dir_path, content= report)
